...
public class CommandsManager implements CommandExecutor {
    ...
    private ArrayList<MusicalSheepsCommand> cmds = new ArrayList<MusicalSheepsCommand>();
    ...
    /**
     * Triggered when a player executed the command /ms | /musicalsheeps.
     *
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("musicalsheeps")
            ...
            MusicalSheepsCommand c = getCommand(args[0]);
     ...
     * @return the aliases.
     */
    private String aliases(MusicalSheepsCommand cmd) {
        String fin = "";
     ...
     */
    private MusicalSheepsCommand getCommand(String name) {
        for (MusicalSheepsCommand cmd : cmds) {
